        ...
        while not self.finished:
            ...
            if playerGridParams["special_used"] == False:
                ...
                special_buttonParams = {
                    ...
                    "width": 170,
                    "height": 50,
                    "action": self.toggle_special,
                    "text": "Special Move",
                    "button_color": self.colors["RED"] if self.special_enabled else self.colors["LIGHT_GRAY"]
                }
                special_button = Button(self.colors, self.gameParams, special_buttonParams)
                special_button.draw()
